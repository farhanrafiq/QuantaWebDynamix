...
const BlogTag: React.FC = () => {
  ...
  if (!blogData || !tag) return <div>Loading...</div>;
        ...
        <section className="pt-32 pb-16 px-4 sm:px-6 lg:px-8">
          <div className="max-w-7xl mx-auto">
            ...
            >
              ...
              >
                {tagPosts.length} articles with this tag
              </motion.p>
            </motion.div>
          </div>
        </section>
                    ...
                    <div className="p-6">
                      ...
                      <div className="flex flex-wrap gap-1 mb-4">
                        {post.tags.slice(0, 3).map(postTag => (
                          <Link key={postTag} href={`/blog/tag/${postTag}`}>
                            <span className={`px-2 py-1 text-xs rounded transition-colors cursor-pointer ${
                              postTag === decodedTag 
                                ? 'bg-electric-blue/20 text-electric-blue border border-electric-blue/30' 
                                : 'bg-neutral-800 text-neutral-400 hover:bg-electric-blue/10 hover:text-electric-blue'
                            }`}>
                              {postTag}
                            </span>
                          </Link>
                ...
                {blogData.tags
                  ...
                  .map(relatedTag => (
                    <Link key={relatedTag} href={`/blog/tag/${relatedTag}`}>
                      <span className="px-3 py-1 bg-[#15171B]/80 border border-electric-blue/20 rounded-full text-neutral-300 hover:border-electric-blue/40 hover:text-electric-blue transition-colors cursor-pointer text-sm">
                        {relatedTag}
                      </span>
                    </Link>
                  ))}
